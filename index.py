...
class AnalysisWindow():
	...
	# Set up analysis window
		...
		self.mlColorSegButton = Checkbutton(analysis, width=20, text="MatLab Color Segmenation", bg='#FCE5B3',
										    onvalue = "ml_color_segment", offvalue = None, variable = self.runVar3, anchor = W)
